...
################################################################################
## Form generated from reading UI file 'formRegFacturasAC.ui'
##
...
"border-radius:5px;")
        ...
        self.btnSalir.setGeometry(QRect(360, 440, 150, 40))
        font1 = QFont()
...
"color: rgb(216, 224, 236);")
        ...
        self.cmbTipoCuota.setGeometry(QRect(30, 130, 231, 30))
...
"border-radius:5px;")
        ...
        self.txtComentarios.setGeometry(QRect(30, 290, 231, 61))
        ...
        self.label_11.setGeometry(QRect(310, 110, 91, 16))
        ...
        self.cmbTipoFact.setGeometry(QRect(310, 130, 151, 30))
...
"border-radius:5px;")
        ...
        self.txtNumFact.setGeometry(QRect(310, 50, 141, 30))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_13.setText(QCoreApplication.translate("Dialog", u"  FACTURAS AREAS COMUNES", None))
        ...
        self.cmbTipoCuota.setItemText(2, QCoreApplication.translate("Dialog", u"cuota garantia", None))
        self.cmbTipoCuota.setItemText(3, QCoreApplication.translate("Dialog", u"cuota anticipada", None))
        self.cmbTipoCuota.setItemText(4, QCoreApplication.translate("Dialog", u"cuota recuperacion servicio", None))
        self.cmbTipoCuota.setItemText(5, QCoreApplication.translate("Dialog", u"cuota anual", None))
        self.cmbTipoCuota.setItemText(6, QCoreApplication.translate("Dialog", u"cuota publicidad", None))
        self.cmbTipoCuota.setItemText(7, QCoreApplication.translate("Dialog", u"cuota estacionamiento", None))
        self.cmbTipoCuota.setItemText(8, QCoreApplication.translate("Dialog", u"cuota uso ba\u00f1os", None))
