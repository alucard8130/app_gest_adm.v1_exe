...
"border-radius:5px;")
        ...
        self.label_3.setGeometry(QRect(860, 90, 121, 21))
        ...
        self.label_4.setGeometry(QRect(470, 90, 121, 16))
        ...
        self.btnBuscar.setGeometry(QRect(10, 500, 150, 41))
        font1 = QFont()
...
"border-radius:5px;")
        self.cmbCliente.setInsertPolicy(QComboBox.InsertPolicy.NoInsert)
    ...
    def retranslateUi(self, formPrincipalAC):
        ...
        self.cmbCliente.setItemText(0, QCoreApplication.translate("formPrincipalAC", u"------seleccione una opcion------", None))
